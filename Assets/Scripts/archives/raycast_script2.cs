...
public class raycast_script2 : MonoBehaviour
{
    ...
    public float multiplier,scale,offset,tot,RL_V_val;

    List<float> vals,bef,aft,bp_vals,tl_vals,rev_vals;
    ...
    void Start()
    {
        //Transmission Loss Calculation -> Start of initialization

       
        //End of initialization

        //Start of raycast initialization
        ...
        //End of raycast initialization
       
    }
    private void Update()
    {
        aft = new List<float>();
        bp_vals = new List<float>();
        tl_vals = new List<float>();
